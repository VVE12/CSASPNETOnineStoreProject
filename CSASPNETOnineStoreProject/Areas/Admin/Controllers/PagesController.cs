using CSASPNETOnineStoreProject.Models.Data;
using CSASPNETOnineStoreProject.Models.ViewModels.Pages;
using System;
...
namespace CSASPNETOnineStoreProject.Areas.Admin.Controllers
{
    public class PagesController : Controller
    {
        ...
        public ActionResult AddPage(PageVM model)
        {
            ...
            using (Db db = new Db())
            {
                ...
                // Make sure title and slug unique
